...
const Testimonial = () => {
  return (
    ...
    <div className="testimonial-container">
        ...
        <div className="user">
        <img src="src\assets\images\avatar-anisha.png" alt="user1" />
        <h4>  Anisha Li</h4>
        ...
        <div className="user">
            <img src="src\assets\images\avatar-ali.png" alt="user1" />
            <h4>    Ali Bravo  </h4>
  ...
  more focused.”</p>
        ...
        <div className="user">
            <img src="src\assets\images\avatar-richard.png" alt="user1" />
            <h4>    Richard Watts
            </h4>
  ...
  and focused. I can’t stop recommending them to everyone I talk to!”
        ...
        <div className="user">
            <img src="src\assets\images\avatar-shanai.png" alt="user1" />
            <h4>     Shanai Gough
            </h4>
